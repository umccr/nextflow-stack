...
export class OncoanalyserStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: IOncoanalyserStackProps) {
    ...
    new StringParameter(this, 'SsmParameter-oncoanalyser-batch_task_instance_role', {
      parameterName: "/nextflow_stack/oncoanalyser/batch_task_instance_role_arn",
      stringValue: roleBatchInstanceTask.roleArn,
    });
    new StringParameter(this, 'SsmParameter-oncoanalyser-batch_task_instance_profile', {
      parameterName: "/nextflow_stack/oncoanalyser/batch_task_instance_profile_arn",
